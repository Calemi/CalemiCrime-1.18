package com.tm.calemicrime.client.model;
...
public class CapeItemModel extends Model {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(CCReference.MOD_ID, "cape"), "item");
